...
## Introduction
This project implements a mock trading environment to simulate and evaluate stock
trading strategies. We tested multiple strategies, including SMA and ARIMA/SARMIMA
forecasting models, on a portfolio of five selected stocks. The goal of this lab was to
design and implement a system that simulates real-world stock trading and evaluates
different strategies.
Our contributions are twofold:
* A trading environment that executes trades, tracks portfolio performance, and
evaluates results.
* Several trading algorithms (based on technical indicators and time-series models)
were tested under the same framework.

we implemented a stock price data pipeline that integrates:
- Real-time data collection using Yahoo Finance API
- Storage and management of stock data in a MySQL database
- Data analysis to ensure data reliability for future trading processes


## I am responsible for:

* Databasing - Database designation, and using the generated dataframe to put into MySQL database
* Mock Trading Environment implementation
